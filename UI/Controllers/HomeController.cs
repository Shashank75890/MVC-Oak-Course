...
namespace UI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult PostDetail(int  ID)
        {
            ...
            ViewData["LayoutDTO"] = layoutdto;
            GeneralDTO dto = new GeneralDTO();
            dto=bll.GetAllPostDetailPageItemsWithID(ID);
            return View(dto);
        }
        [HttpPost]
        public ActionResult PostDetail(GeneralDTO model) 
        {
            ...
            ViewData["LayoutDTO"] = layoutdto;
            GeneralDTO dto = new GeneralDTO();
            model = bll.GetAllPostDetailPageItemsWithID(model.PostID);
            return View(model);
        }
        [Route("contactus")]
        ...
        public ActionResult Search(GeneralDTO model)
        {
            ...
            ViewData["LayoutDTO"] = layoutdto;
            GeneralDTO dto = new GeneralDTO();
            dto = bll.GetSearchPost(model.SearchText);
            return View(dto);
        }
    }
}