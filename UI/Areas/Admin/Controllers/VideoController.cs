...
namespace UI.Areas.Admin.Controllers
{
    public class VideoController : BaseController
    {
        ...
        {
           // < iframe width = "560" height = "315" src = "https://www.youtube.com/embed/E7Voso411Vs?si=33zYJ_Fr6ryToO7f" title = "YouTube video player" frameborder = "0" allowfullscreen ></ iframe >
            //    https://www.youtube.com/watch?v=E7Voso411Vs
            if(ModelState.IsValid)
            {
                string path = model.OriginalVideoPath.Substring(32);//this will delete the first 32 characters
