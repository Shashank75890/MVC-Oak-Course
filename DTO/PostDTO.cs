...
namespace DTO
{
    public class PostDTO
    {
        ...
        [Required(ErrorMessage ="Pleaase fill the Title Area")]
        public string Title { get; set; }
        [Required(ErrorMessage = "Pleaase fill the ShortContent Area")]
        public string ShortContent { get; set; }
        [Required(ErrorMessage = "Pleaase fill the PostContent Area")]
        [AllowHtml]
        public string PostContent { get; set; }
        [Required(ErrorMessage = "Pleaase select a Category")]
